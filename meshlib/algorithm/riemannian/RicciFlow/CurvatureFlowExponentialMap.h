/*! \file CurvatureFlowExponentialMap.h
 * \brief Curvature Flow Exponential Map
 *  \author David Gu
 *  \date   documented on 11/15/2010
 *
 *	Algorithm for Curvature Flow Exponential Map
 */

#ifndef _CURVATURE_FLOW_EXPONENTIAL_MAP_H_
#define _CURVATURE_FLOW_EXPONENTIAL_MAP_H_
...
namespace RicciFlow
{
	/*! \brief CCurvatureFlowExponentialMap class
	 *  
	 *  Algorithm for Exponential Map for Curvature Flow Embedding result
	 */
	 
 template<typename M>
 class CCurvatureFlowExponentialMap
  {
  public:
	  /*! \brief CCurvatureFlowExponentialMap constructor
	   *
	   *  call base class constructor 
	   */
	  CCurvatureFlowExponentialMap( M * pCMesh, M * pOMesh );
...
template<typename M>
CCurvatureFlowExponentialMap<M>::CCurvatureFlowExponentialMap( M * pCMesh, M * pOMesh  )
{
	m_pCMesh = pCMesh;
	m_pOMesh = pOMesh;
