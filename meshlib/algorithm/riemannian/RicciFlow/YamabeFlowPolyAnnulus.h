/*! \file YamabeFlowPolyAnnulus.h
 * \brief Euclidean Yamabe flow for Poly Annulus
 *  \author David Gu
 *  \date   documented on 11/15/2010
 *
 *	Algorithm for Euclidean Yamabe Flow for Poly Annulus
 */

#ifndef _YAMABE_FLOW_POLY_ANNULUS_H_
#define _YAMABE_FLOW_POLY_ANNULUS_H_
...
namespace RicciFlow
{
	/*! \brief CYamabeFlowPolyAnnulus class
	 *  
	 *  Algorithm for Euclidean Yamabe flow for Poly Annulus
	 */
	 
 template<typename M>
 class CYamabeFlowPolyAnnulus : public CYamabeFlow<M>
  {
  public:
	  /*! \brief CYamabeFlowPolyAnnulus constructor
	   *
	   *  call base class constructor 
	   */
	  CYamabeFlowPolyAnnulus( M * pMesh );
...
template<typename M>
CYamabeFlowPolyAnnulus<M>::CYamabeFlowPolyAnnulus( M * pMesh ): CYamabeFlow( pMesh)
{
}
...
template<typename M>
void CYamabeFlowPolyAnnulus<M>::_set_target_curvature()
{
...
template<typename M>
void CYamabeFlowPolyAnnulus<M>::_Newton( double threshold, double step_length )
{
...
template<typename M>
void CYamabeFlowPolyAnnulus<M>::_calculate_metric()
{
