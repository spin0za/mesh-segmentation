...
*   Mesh for viewer 
*/
#ifndef  _TRIANGLE_CUBE_INTERSECTION_H_
#define  _TRIANGLE_CUBE_INTERSECTION_H_
...
public:
	CTriangleCubeIntersect(){};
	~CTriangleCubeIntersect(){};
	long test( CPoint a, CPoint b, CPoint c )
	{
		Triangle3 t;
...
long check_point(Point3 p1, Point3 p2, REAL alpha, long mask)
{
Point3 plane_point;
